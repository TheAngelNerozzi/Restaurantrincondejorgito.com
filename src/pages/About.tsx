      ...
      <section className="py-16 bg-muted/30 fade-in-section">
        <div className="container max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-lg overflow-hidden shadow-sm">
              <img src="https://images.unsplash.com/photo-1593692557859-b209f9f4ced4?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Peruvian Amazon" className="w-full h-64 object-cover" />
              <div className="p-4">
