          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative lg:order-2">
              <div className="rounded-lg overflow-hidden shadow-lg">
                 <img alt="Restaurant interior" src="/elrincondejorgitoinside.png" className="w-full h-auto object-cover" />
              </div>
      ...
      <section ref={specialsRef} className="py-20 bg-muted/30 fade-in-section">
        <div className="container">
          <div className="text-center mt-8">
            <Button asChild>
              <Link to="https://menu-restaurantrincondejorgito-com.vercel.app" target="_blank" rel="noopener noreferrer">
                View Full Menu
