  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const templateParams = {
        to_name: "Restaurante Rincón de Jorgito",
        to_email: "restaurantdejorgitoadm@gmail.com",
        from_name: "Restaurante Rincón de Jorgito",
        from_email: "restaurantdejorgitoadm@gmail.com",
        fullName: payload.name,
        phoneNumber: payload.phone,
        date: payload.date,
        time: payload.time,
        numberOfGuests: payload.guests,
        specialRequests: payload.message || 'No hay mensaje',
        reservation_type: reservationType === 'event' ? 'Evento' : 'Mesa',
      ...
      await emailjs.send(
        import.meta.env.VITE_EMAILJS_SERVICE_ID || 'service_restaurante', // ID de servicio de EmailJS
        import.meta.env.VITE_EMAILJS_TEMPLATE_ID || 'template_reservaciones', // ID de template de EmailJS
        templateParams,
        import.meta.env.VITE_EMAILJS_PUBLIC_KEY // Clave pública de EmailJS
      );
